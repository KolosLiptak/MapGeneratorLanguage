...
public class ColorReference_SubstituteMenu extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_j87eyw_a(), CONCEPTS.ColorReference$K$));
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for ColorReference. Generated from implicit smart reference attribute.", new SNodePointer("r:58a5e344-c0be-49ce-83fe-40662317bfd1(MapGen_Language.structure)", "3017907695058510592")));
    try {
  ...
  public class SMP_ReferenceScope_j87eyw_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_j87eyw_a() {
      ...
      super((SAbstractConcept) CONCEPTS.ColorReference$K$, LINKS.color$_29r);
    }
    @NotNull
    @Override
  ...
  public class SMP_Subconcepts_j87eyw_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    protected Collection getConcepts(final SubstituteMenuContext _context) {
      return ConceptDescendantsCache.getInstance().getDirectDescendants(CONCEPTS.ColorReference$K$);
    }
    @NotNull
    @Override
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
